    ...
    <section id="projects" className="py-20 bg-gradient-to-b from-muted/20 to-background">
      <div className="container mx-auto px-4 md:px-8">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Other Projects */}
          <div>
            <h3 className="text-2xl font-bold text-center mb-12 text-white bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Other Notable Projects</h3>
